...
$id=$_GET['id'];
$setnum=$_GET['setnum'];
$result = mysqli_query($connect, "SELECT * FROM customer WHERE transactionum='$id'");
...
$results = mysqli_query($connect, "SELECT * FROM reserve WHERE transactionnum='$id'");
while($rows = mysqli_fetch_array($results))
	{
		$ggagaga=$rows['bus'];
		echo 'Route and Type of Bus: ';
		$resulta = mysqli_query($connect,"SELECT * FROM route WHERE id='$ggagaga'");
